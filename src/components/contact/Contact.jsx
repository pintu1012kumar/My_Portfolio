...
function Contact() {
  return (
    <div id='Contact' className='base:px-[10%] px-[4%] pt-[200px] pb-[300px] text-center'>
      <p className='text-lg text-[#ccc]'>Get in Touch</p>
      <h1 className='text-4xl font-bold'>Contact Me</h1>
      <section data-aos="zoom-out" className='border border-[#a2a2a2] mt-14 bg-[#333] rounded-3xl text-center p-5 flex flex-wrap md:justify-center md:gap-8 gap-4 md:w-[80%] mx-auto'>
